...
/**
 * Deploys Hetu contracts on Sepolia:
 * - ConfidentialUSDCWrapper (wraps USDC into private cUSDC) - if not already deployed
 * - HetuPaymentGateway (privacy-first payment gateway)
 *
 * Env vars:
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const gateway = await deploy("HetuPaymentGateway", {
    from: deployer,
    args: [wrapperAddress],
    log: true,
  });
  ...
  console.log(`HetuPaymentGateway:     ${gateway.address}`);
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
