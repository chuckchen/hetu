 ...
 * 
 * This hook is deprecated. Please use useHetuGateway instead.
...
import { useHetuGateway } from './useHetuGateway';
...
export function usePaymentGateway() {
  ...
  return {
    ...
    isProcessing: hetu.isProcessing,
    isEncrypting: hetu.isEncrypting,
    isWritePending: hetu.isWritePending,
    fhevmReady: hetu.fhevmReady,
    lastPayment: null,
