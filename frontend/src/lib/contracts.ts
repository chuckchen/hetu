...
export const CONTRACTS = {
  // HetuPaymentGateway - Main payment gateway
  HETU_GATEWAY: '0xb49712B3BA9042168b2C35E84c9F5B2b561426CC' as const,
  // ConfidentialUSDCWrapper - ERC7984 confidential token wrapper
  WRAPPER: '0xe6832A06dE93088Cd637ea35602075aEcD0f9998' as const,
...
export const GATEWAY = CONTRACTS.HETU_GATEWAY;
...
// ABI for HetuPaymentGateway - From deployment
export const HETU_GATEWAY_ABI = [
  // ============ SEND MONEY ============
  {
    inputs: [
...
export const GATEWAY_ABI = HETU_GATEWAY_ABI;
