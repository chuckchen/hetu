 ...
 * 
 * This page handles checkout flows initiated by the Hetu SDK.
...
const MESSAGE_TYPES = {
  CHECKOUT_READY: 'HETU_CHECKOUT_READY',
  CHECKOUT_CLOSED: 'HETU_CHECKOUT_CLOSED',
  PAYMENT_PENDING: 'HETU_PAYMENT_PENDING',
  PAYMENT_SUCCESS: 'HETU_PAYMENT_SUCCESS',
  PAYMENT_ERROR: 'HETU_PAYMENT_ERROR',
  PAYMENT_CANCELLED: 'HETU_PAYMENT_CANCELLED',
} as const;
...
export function Checkout() {
  ...
  const { send, fhevmReady, approveGateway, isOperatorApproved } = useHetuGateway();
  const { 
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
      ...
      <footer className="py-4 px-6 text-center text-sm text-gray-500">
        <div className="flex items-center justify-center gap-2">
          ...
          <span>Secured by Hetu • Payments encrypted with FHE</span>
        </div>
      </footer>
    </div>
  );
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="text-xs text-gray-500 mt-4 text-center">
          By connecting, you agree to Hetu's Terms of Service
        </p>
      </div>
    </motion.div>
  );
      ...
      <div className="p-6 space-y-4">
        ...
        {!hasCusdcBalance && (
          <div className="bg-amber-50 border border-amber-200 text-amber-800 p-4 rounded-xl text-sm">
            ...
            <a 
              href="https://hetu-dapp.vercel.app" 
              target="_blank" 
