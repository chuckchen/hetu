          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Pay with your Hetu account at any participating merchant. Rest easy knowing 
      ...
      <section id="how-it-works" className="py-24 bg-gray-50">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl">
          ...
          >
            ...
            >
              Start using Hetu in a few simple steps.
            </motion.p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-4xl">
          ...
          >
            <motion.div variants={fadeInUp}>
              <LinkCard title="The Hetu App" href="/dashboard" />
            </motion.div>
            <motion.div variants={fadeInUp}>
              <LinkCard title="How Hetu Works" href="#how-it-works" />
            </motion.div>
            <motion.div variants={fadeInUp}>
