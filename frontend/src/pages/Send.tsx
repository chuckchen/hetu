...
import { useHetuGateway, useConfidentialToken, useFhevm } from '../hooks';
...
export function Send() {
  ...
  // Use Hetu Gateway for sending - handles operator approval internally
  const { send, isProcessing, isEncrypting, fhevmReady: paymentFhevmReady } = useHetuGateway();
  ...
  const handleConfirm = async () => {
    ...
    // Note: useHetuGateway handles operator approval internally in send()
    ...
    try {
      ...
      // useHetuGateway.send() handles operator approval automatically
