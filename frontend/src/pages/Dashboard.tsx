...
export function Dashboard() {
  ...
  const { requestCount } = useHetuGateway();
  ...
  const handleDownloadQR = () => {
    ...
    img.onload = () => {
      ...
      downloadLink.download = `hetu-address-${address?.slice(0, 8)}.png`;
                ...
                {txLoading ? (
                  ...
                  <div className="p-12 text-center">
                    ...
                    <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                      Your encrypted transactions will appear here once you start using Hetu.
                    </p>
